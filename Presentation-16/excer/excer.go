...
func main(){
	...
	//two params
	fmt.Println(nameAge("Vinit",varicadic))

	//two returns
	dogYears, old := dogAge("Vinit", 23)
	var mySentence string = "Vinit is " + strconv.Itoa(dogYears) + " in dog years and is "
	if old {
		mySentence string = "Vinit is " + strconv.Itoa(dogYears) + " in dog years and is "
		if old{
		...
		//named return
		fmt.Println(dogAge2(23))

		//variadic parameters & variadic arguments
		print("hello world...", "this is Vinit", "how are you?")
